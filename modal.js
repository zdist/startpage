...
const updateTime = (date) => {
    ...
    switch (workoutDayIndex) {
        ...
        case 1:
            ...
            break;
        case 2:
            document.getElementById('day-text').innerHTML = '<form><input type="checkbox" id="dLift1" name="dLift1" value="dLift1"><label for="dLift1">Deadlift (3 sets of 8-12 reps)</label><input type="checkbox" id="pUp1" name="pUp1" value="pUp1"><label for="pUp1">Pull-Ups (3 sets of 8-12 reps)</label><input type="checkbox" id="bbRows1" name="bbRows1" value="bbRows1"><label for="bbRows1">Barbell Rows (3 sets of 8-12 reps)</label><input type="checkbox" id="bhCurls1" name="bhCurls1" value="bhCurls1"><label for="bhCurls1">Bicep Curls or Hammer Curls (3 sets of 8-12 reps)</label><input type="checkbox" id="fPull1" name="fPull1" value="fPull1"><label for="fPull1">Face Pulls (3 sets of 8-12 reps)</label></form>';
            break;
        case 3:
            document.getElementById('day-text').innerHTML = '<form><input type="checkbox" id="squat1" name="squat1" value="squat1"><label for="squat1">Squats (3 sets of 8-12 reps)</label><input type="checkbox" id="lunge1" name="lunge1" value="lunge1"><label for="lunge1">Lunges (3 sets of 8-12 reps)</label><input type="checkbox" id="lExten1" name="lExten1" value="lExten1"><label for="lExten1">Leg Extension (3 sets of 8-12 reps)</label><input type="checkbox" id="lCurl1" name="lCurl1" value="lCurl1"><label for="lCurl1">Leg Curls (3 sets of 8-12 reps)</label><input type="checkbox" id="sCalfRaise1" name="sCalfRaise1" value="sCalfRaise1"><label for="sCalfRaise1">Standing Calf Raises (3 sets of 8-12 reps)</label></form>';
            break;
        case 4:
            ...
            break;
        case 5:
            document.getElementById('day-text').innerHTML = '<form><input type="checkbox" id="dLift2" name="dLift2" value="dLift2"><label for="dLift2">Deadlift (3 sets of 8-12 reps)</label><input type="checkbox" id="pUp2" name="pUp2" value="pUp2"><label for="pUp2">Pull-Ups (3 sets of 8-12 reps)</label><input type="checkbox" id="bbRows2" name="bbRows2" value="bbRows2"><label for="bbRows2">Barbell Rows (3 sets of 8-12 reps)</label><input type="checkbox" id="bhCurls2" name="bhCurls2" value="bhCurls2"><label for="bhCurls2">Bicep Curls or Hammer Curls (3 sets of 8-12 reps)</label><input type="checkbox" id="fPull2" name="fPull2" value="fPull2"><label for="fPull2">Face Pulls (3 sets of 8-12 reps)</label></form>';
            break;
        case 6:
